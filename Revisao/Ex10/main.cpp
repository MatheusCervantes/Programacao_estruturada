...
int main() {
    ...
    for (int i = 0; i < n; ++i) {
        arq1 << "Cliente " << i+1 << endl << endl;
        arq1 << "Nome do PET: " << strPet[i].nomepet << endl;
        arq1 << "Espécie do PET: " << strPet[i].especie << endl;
        arq1 << "Raça do PET: " << strPet[i].raca << endl;
        arq1 << "Sexo do PET: " << strPet[i].sexo << endl;
        arq1 << "Idade do PET: " << strPet[i].idade << endl;
        arq1 << "Nome do dono do PET: " << strPet[i].dono_pet << endl;
        arq1 << "RG: " << strPet[i].rg << endl;
        arq1 << "Telefone: " << strPet[i].numero << endl << endl << endl;
    }
    return 0;
